 /** * @author Swfdong * Aii基本按钮组件 */package aii.ui.controls.bases {	import aii.ui.core.*;	import aii.ui.managers.GraphicManager;		import flash.events.MouseEvent;	import flash.events.TimerEvent;	import flash.filters.GlowFilter;	import flash.filters.DropShadowFilter;	import flash.utils.Timer;	public class ButtonBase extends UIComponent {		//私有属性		public static const defaultStyle:Object = {hover:{borderColor:0x0877F3,filters:[new GlowFilter(0x0877F3, 1, 2,2,4)]},active:{borderColor:0x0877F3,filters:[new DropShadowFilter(2, 90,0x0, 1, 8, 8, 0.3, 1,true),new GlowFilter(0x0877F3, 1, 2,2,4)]}};		protected var _pressRepeat:Boolean = false;		protected var _selected:Boolean = false;		protected var isDown:Boolean = false;		protected var pressTimer:Timer = new Timer(210);
